                            ...
                            <form action="editarPerfil.php" method="POST">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select name="estado" id="estado" class="form-control" style="padding: 0 0 0 10px;"
                                        ...
                                        <option value="AP" <?= $estadoSelecionado === 'AP' ? 'selected' : '' ?>>Amapá
                                        </option>
                                        <option value="AM" <?= $estadoSelecionado === 'AM' ? 'selected' : '' ?>>
                                            Amazonas
                                        </option>
                                        <option value="BA" <?= $estadoSelecionado === 'BA' ? 'selected' : '' ?>>Bahia
                                        </option>
                                        <option value="CE" <?= $estadoSelecionado === 'CE' ? 'selected' : '' ?>>Ceará
                                        </option>
                                        <option value="DF" <?= $estadoSelecionado === 'DF' ? 'selected' : '' ?>>Distrito
                                            Federal
                                        </option>
                                        <option value="ES" <?= $estadoSelecionado === 'ES' ? 'selected' : '' ?>>Espírito
                                            Santo
                                        </option>
                                        <option value="GO" <?= $estadoSelecionado === 'GO' ? 'selected' : '' ?>>Goiás
                                        </option>
                                        ...
                                        <option value="MG" <?= $estadoSelecionado === 'MG' ? 'selected' : '' ?>>Minas
                                            Gerais
                                        </option>
                                        ...
                                        <option value="PR" <?= $estadoSelecionado === 'PR' ? 'selected' : '' ?>>Paraná
                                        </option>
                                        <option value="PE" <?= $estadoSelecionado === 'PE' ? 'selected' : '' ?>>
                                            Pernambuco
                                        </option>
                                        <option value="PI" <?= $estadoSelecionado === 'PI' ? 'selected' : '' ?>>Piauí
                                        </option>
                                        <option value="RJ" <?= $estadoSelecionado === 'RJ' ? 'selected' : '' ?>>Rio de
                                            Janeiro
                                        </option>
                                        ...
                                        <option value="SC" <?= $estadoSelecionado === 'SC' ? 'selected' : '' ?>>Santa
                                            Catarina
                                        </option>
